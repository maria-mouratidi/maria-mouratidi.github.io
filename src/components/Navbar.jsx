...
const themeNavbarStyles = {
  light: {
    ...
    link: "text-gray-600",
    active: "bg-dusty-50 text-dusty-800",
    hover: "hover:text-dusty-700",
    fill: "bg-white/60",
    outline: "ring-dusty-500/30",
    highlight: "bg-dusty-600/70",
  ...
  dark: {
    ...
    link: "text-gray-400",
    active: "bg-dusty-500/10 text-dusty-300",
    hover: "hover:text-dusty-600",
    fill: "bg-white/[0.06]",
    outline: "ring-dusty-600/30",
    highlight: "bg-dusty-600/70",
